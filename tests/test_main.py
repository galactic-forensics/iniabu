...
# fixme insert lin, log both selected with parametrization of pytest
def test_iso_int_norm_zeros(ini_default):
    ...
    retval = ini_default.iso_int_norm(isos, norm_isos, smp_values, norm_values)
...
def test_iso_int_norm_exp_multi_isos(ini_default, smp_values):
    ...
    nominator_iso = ini_default._get_all_isos("Ni")
    norm_isos_ind = (0, 3)
    norm_isos = (nominator_iso[norm_isos_ind[0]], nominator_iso[norm_isos_ind[1]])
